...
\begin{figure}[htbp]
    ...
    \Description{Virtual Coupling between Representation and Actual End Effector. Note that the \textbf{"End Effector Actual"} is never visualized in the tool itself.}
...
\begin{figure}[htbp]
    ...
    \Description{Two different textures providing different jittery sensations}
...
\begin{figure}[htbp]
    ...
    \Description{The final terrain painting interface}
